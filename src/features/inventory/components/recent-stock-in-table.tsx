...
import type { RecentStockInTableProps } from "./stock-ui.types";
import { AppDataGrid } from "@/shared/ui/app-data-grid";

export function RecentStockInTable({ data }: RecentStockInTableProps) {
  ...
  const columns = useMemo<GridColDef[]>(
    () => [
      ...
      { field: "party", headerName: t("supplier"), minWidth: 160 },
      {
        field: "quantity",
    ...
    >
      <Stack
        ...
        sx={{
          ...
          py: 1.75,
          backgroundImage:
            "linear-gradient(135deg, color-mix(in srgb, var(--mui-palette-primary-main) 6%, transparent), transparent 52%)",
        }}
      >
